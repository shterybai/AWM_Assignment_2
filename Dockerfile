...
ENV DJANGO_SETTINGS_MODULE=godjango_tutorial.settings
...
RUN conda env create -n godjango_tutorial --file ENV.yml

# Make RUN commands use the new environment
# See https://pythonspeed.com/articles/activate-conda-dockerfile/ for explanation
RUN echo "conda activate godjango_tutorial" >> ~/.bashrc
